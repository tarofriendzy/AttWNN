...
from model import AttWNN
from utils import load_data, generate_batches, accuracy, AverageMeter

# Argument parser
parser = argparse.ArgumentParser(description='AttWNN')
parser.add_argument('--dataset', default='Dataset-1', help='Dataset name')
...
for train_index, test_index in kf.split(y):
    ...
    model = AttWNN(features_dim, args.max_step, args.hidden_graphs, args.size_hidden_graphs, args.hidden_dim, args.penultimate_dim, args.normalize, n_classes, args.dropout, device).to(device)
